...
1. Get your Yale NET ID and e-mail set up.
    ...
    - Check with Sam to schedule an appointment with Dan Holland to set up your laptop and to get access to our server. You will Chima to approve access to Dan Holland for the following groups: 
